...
@interface RCTTextFieldView () <RCTComponentViewProtocol>
@end

@implementation RCTTextFieldView {
...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    __weak RCTTextFieldView *weakSelf = self;
    _containerView.onChange = ^(NSString *newValue) {
      __strong RCTTextFieldView *strongSelf = weakSelf;
      if (strongSelf) {
